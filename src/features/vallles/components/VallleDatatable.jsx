 ...
 * @returns {JSX.Element}
 */
const VallleDatatable = ({ vallles, filters, actions, pageSize, serverPagination, serverSearch, serverSort }) => {
  // Hooks
  ...
  // Handlers
  const handleRowClick = useCallback((vallle) => {
    navigate(valllePath(vallle.id), { state: { backgroundLocation: location } })
  }, [navigate, location])

...
const VoucherCreate = () => {
  ...
  return (
    <form
      className="p-voucher-create"
      noValidate
      onSubmit={handleSubmit(onSubmit)}
    >
      <div className="p-voucher-create__amount">
        <div className="p-voucher-create__amount-input">
          <input
            aria-label={t("features.vouchers.create.amount")}
            autoComplete="off"
            autoFocus={true}
            className="p-voucher-create__amount-input-amount"
            inputMode="decimal"
            ...
            {...register("amount", {
              ...
              validate: {
                positive: (v) =>
                  ...
                  t("features.vouchers.create.error.amountPositive"),
              },
            })}
          />
          <span className="p-voucher-create__amount-input-currency">€</span>
        </div>
        {errors.amount && (
          <div className="p-voucher-create__amount-error">
            {errors.amount.message}
          </div>
        )}
      </div>

      <div className="p-voucher-create__buyer">
        <label className="p-voucher-create__buyer-label" htmlFor="buyer">
          {t("features.vouchers.create.buyer")}
        </label>
        <input
          autoComplete="off"
          className={`p-voucher-create__buyer-input${errors.buyer ? " p-voucher-create__buyer-input--error" : ""}`}
          id="buyer"
          placeholder={t("features.vouchers.create.buyerPlaceholder")}
          type="text"
          {...register("buyer", {
            required: t("features.vouchers.create.error.buyerRequired"),
          })}
        />
        {errors.buyer && (
          <div className="p-voucher-create__buyer-error">
            {errors.buyer.message}
          </div>
        )}
      </div>

      <div className="p-voucher-create__expiry">{expiryLabel}</div>

      {serverError && <div className="c-form__error">{serverError}</div>}

      <div className="p-voucher-create__actions">
        <Button
          display="block"
          fullWidth={true}

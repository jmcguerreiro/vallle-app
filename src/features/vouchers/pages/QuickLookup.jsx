...
import { formatVoucherCode } from "@/features/vouchers/utils";
 ...
 * voucher view on success, or shows an empty state if the code
  ...
  if (lookupResult) {
    return (
      <div className="p-voucher-quick-lookup">
        <div className="p-voucher-quick-lookup__empty-state">
          {lookupResult.status === "not-found" && (
            <EmptyState
              ...
              description={t("features.vouchers.quickLookup.notFound", {
                code: lookupResult.code,
              })}
              image="lookup-voucher--not-found"
            />
          )}
          ...
          {lookupResult.status === "error" && (
            <EmptyState
              ...
              description={t("features.vouchers.quickLookup.error")}
              image="lookup-voucher--error"
            />
          )}
        </div>
      </div>
  ...
  return (
    <div className="p-voucher-quick-lookup">
      ...
      <div className="p-voucher-quick-lookup__actions">
        ...
        >
          {t("features.vouchers.quickLookup.submit")}
        </Button>
      </div>
    </div>
  );
